...
namespace Flipper_Info
{
    ...
    constexpr auto flip_pickup_time = 5s;
    constexpr auto flip_time = 2s;
    
    constexpr auto serve_pickup_time = 5s;
...
{
    using namespace std;
    constexpr auto mix_time = 1s;//20s;  
    constexpr auto mix_dispence_time = 2s;//5s
    constexpr auto side_1_cook_time = 1s;// 2.25min;
    constexpr auto side_2_cook_time = 15s;//2min;
} /* Cooking_Times */
